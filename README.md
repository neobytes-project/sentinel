...
Sentinel is an autonomous agent for persisting, processing and automating NeoBytes governance objects and tasks. It is a Python application which runs alongside the NeoByteshCore instance on each NeoBytes Masternode.
