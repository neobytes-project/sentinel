...
min_neobytesd_proto_version_with_sentinel_ping = 70207


def get_neobytes_conf():
    home = os.environ.get('HOME')

    neobytes_conf = os.path.join(home, ".neobytes/neobytes.conf")
    if sys.platform == 'darwin':
        neobytes_conf = os.path.join(home, "Library/Application Support/Neobytes/neobytes.conf")
